(function($, window, document, undefined){
	...
	window.ef_testing = {
		...
		buildDatabase:function() {
			// var data = {title:'dis1', description:'this'};
			// var Table = helpers.getTable('discipline');
			// var obj = new Table();
			// var data = {title:'root'};

			// obj.save(data).done(function(root){
			// 	var data = {title:'dis1', description:'this', parent:root};
			// 	obj.save(data).done(function(entry){
			// 		console.log(entry);
			// 	});
			// });
